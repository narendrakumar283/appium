...
public class DragAndDrop 
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			...
			w.until(ExpectedConditions.elementToBeClickable(MobileBy.AccessibilityId("dragAndDrop")));
			...
			try 
			{
				...
				System.out.println("Drog and Drop test passed");
				
			}
			catch(Exception ex)
			{
				System.out.println("Drog and Drop test failed");
				File src=driver.getScreenshotAs(OutputType.FILE);
				File dest=new File("Droddropdefectscree.png");
