...
public class Pinch_Zoom 
{
	...
	
	{
		...
		try
		{
			...
			w.until(ExpectedConditions.elementToBeClickable(MobileBy.AccessibilityId("photoView"))).click();
			//logic
			Thread.sleep(5000);
			PointerInput finger1=new PointerInput(PointerInput.Kind.TOUCH,"finger1");
			PointerInput finger2=new PointerInput(PointerInput.Kind.TOUCH,"finger2");
			Dimension size=driver.manage().window().getSize();//app screen size in device
