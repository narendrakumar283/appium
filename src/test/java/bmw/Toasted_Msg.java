...
public class Toasted_Msg 
{
	...
	public static void main(String[] args)throws Exception
	{
		...
		try
		{
			...
			w.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/hierarchy/android.widget.Toast")));
			String tm=driver.findElement(By.xpath("/hierarchy/android.widget.Toast")).getText();
